...
\begin{abstract}
  ...
  \textbf{TODO}, while Model 1 and Model 2 achieved \textbf{TODO}
  and \textbf{TODO} respectively.  In the second part of the assignment,
  I implemented a feature for Phrasal which was able to achieve a
  \textbf{TODO} BLEU score.
\end{abstract}

\section{Part 1}

Doing stuff in general.
